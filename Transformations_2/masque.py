img = "Transformations_2\\input\empreinte_overlined_tournee.jpeg"
...
FICHIER_OUT = "Transformations_2\\tests"
...
"""
on veut creer un masque binaire pour isoler empreintre :
0= masque
255= empreinte
"""
def masque_fun(img_grise):
    ...
    k = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (40,40))  #COMMENT :⚠️si trop aggressif baissé ou augmenter la taille (memo 15 ok la plupart du temps)
